...
class User extends \UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'mail', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'passwordConfirmation');
        }
    ...
    public function setPasswordConfirmation($passwordConfirmation)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPasswordConfirmation', array($passwordConfirmation));
    ...
    public function getPasswordConfirmation()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPasswordConfirmation', array());
